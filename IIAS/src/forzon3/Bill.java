...
String  itecode="",itename="";
    ...
    connection();
        ...
        pst1=con.prepareStatement("insert into sales_information(`order_id`, `sr.no.`, `item_code`, `item_name`, `quality`, `Amount`,price) values(?,?,?,?,?,?,?)");
          ...
          System.out.println();
              pst1.setInt(1, Integer.parseInt(jLabel19.getText()));
             pst1.setInt(2,i);
  ...
  System.out.print("lie 113"+ex);   
     ...
     public void return_sell(){
         ...
         try{
             connection();
                pst=con.prepareStatement("insert into inflow_sell(Order_Id,user_id, name, Total) values(?,?,?,?)",Statement.RETURN_GENERATED_KEYS);        
...
String  itecode="",itename="";
    ...
    connection();
        ...
        pst1=con.prepareStatement("insert into inflow_sell_information(`sr_no`, `Order_id`, `item_code`, `item_name`, `quality`, `Amount`) values(?,?,?,?,?,?)");
                    itecode=  jTable1.getValueAt(i, 0).toString();
            itename=  jTable1.getValueAt(i, 1).toString();
          int q=Integer.parseInt(jTable1.getValueAt(i, 2).toString());
          int am=Integer.parseInt(jTable1.getValueAt(i, 3).toString());
         
           System.out.print(itecode+" "+itename+" "+q+" "+am);
          System.out.println();
           pst1.setInt(1,i);
              pst1.setInt(2, Integer.parseInt(jTextField10.getText()));
...
jTextField6.setText(String.valueOf(pr));
 ...
 m.put("invoice",Integer.parseInt(jLabel19.getText()));
 try{
...
jr.jPanel1.revalidate();
 ...
 jr.setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel26.setBounds(896, 100, 103, 29);
        ...
        jLabel30.setBounds(50, 250, 138, 29);
        ...
        jTextField12.setBounds(50, 300, 279, 30);
        ...
        jLabel31.setBounds(379, 250, 136, 29);
        ...
        jTextField13.setBounds(379, 300, 279, 30);
        ...
        jLabel32.setBounds(708, 250, 79, 29);
        ...
        jTextField14.setBounds(708, 300, 279, 30);
        ...
        jLabel33.setBounds(1037, 250, 125, 29);
        ...
        jLabel34.setBounds(1366, 250, 108, 29);
        ...
        jTextField15.setBounds(1366, 300, 279, 30);
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Name", "Quality", "Amount", "price"
            }
        ));
        ...
        jScrollPane4.setBounds(50, 370, 1142, 263);
        ...
        jButton9.setBounds(1230, 500, 415, 50);
        ...
        jButton10.setBounds(1230, 570, 415, 50);
        ...
        jLabel35.setBounds(1230, 370, 82, 29);
        ...
        jTextField16.setBounds(1230, 410, 415, 30);
        ...
        jSpinner2.setBounds(1037, 300, 279, 30);
  ...
  int sum=0;
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        try{
            ...
            jLabel19.setText(String.valueOf(ord+1));
con.close();
        }catch(Exception e){
            System.out.print(e);
        }
...
int i=jTable4.getSelectedRow();
 ...
 if(i>=0){
     add.setValueAt(jSpinner2.getValue().toString(), i, 2);
     add.setValueAt(jTextField15.getText(), i, 3);
       int sum=0;
        int j;
...
TableModel model=jTable4.getModel();
     ...
     jSpinner2.setValue(Integer.parseInt(model.getValueAt(i,2).toString()));
